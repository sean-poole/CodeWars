...
/*
P - List of arguments as an argument.
R - String representing the given list of arguments.
E - 
stringify(new Node(1, new Node(2, new Node(3))))
>> Returns "1 -> 2 -> 3 -> null"

stringify(new Node(0, new Node(1, new Node(4, new Node(9, new Node(16))))))
>> Returns "0 -> 1 -> 4 -> 9 -> 16 -> null"

stringify(null)
>> Returns "null"
P - 
function stringify(list) {
  // If the given list is null, return "null".
  // Else, format string to include the value of list's data property.
  // Append data with " -> " and recursively call stringify for the remaining list argument.
  // Return string.
}
*/
class Node {

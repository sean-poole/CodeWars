...
/*
P - One argument as an object containing keys and values as strings.
R - Array with elements of the given object's keys & values with a length === 5.
E - 
...
function giveMeFive(obj) {
  // Create an empty array variable to store keys & values with a length of 5.
  // Iterate through the given object.
  // If the current key has a length of 5, push to the created array.
  // If the current value has a length of 5, push to the created array.

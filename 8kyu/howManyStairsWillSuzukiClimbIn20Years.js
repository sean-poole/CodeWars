...
R - Integer representing the number of steps taken over 20 years using the given array.
E - stairsIn20(stairs)      // 54636040
P - 
function stairsIn20(s) {
    // Within the given array, reduce each array element.
    // Reduce the array after its containing arrays return an integer.
    // Multiply the integer by 20.
    // Return integer.
}
*/

const stairsIn20 = s => s.reduce((acc, c) => acc += c.reduce((acc, c) => acc += c, 0), 0) * 20;

...
R - String representing the given string with "*" as padding determined by the given integer.
E - 
padIt("a", 1)   // "*a"
padIt("a", 2)   // "*a*"
padIt("a", 3)   // "**a*"
...
function padIt(str, n) {
  // Create a loop while n is greater than 0.
  // If the current iteration is even, add "*" padding to the end of the string.
  // If the current iteration is odd, add "*" padding to the front of the string.
  // Decrement n.
  // Return string.
}
*/
...
// function padIt(str, n) {
//   let arr = [];
//   while (arr.filter(e => e === "*").length !== n) {
//     arr.push("*");
//   }

//   arr.splice(Math.ceil(arr.length / 2), 0, str);
